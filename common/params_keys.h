...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"TFollowAggressive", PERSISTENT | BACKUP},
    {"TFollowStandard", PERSISTENT | BACKUP},
    {"TFollowRelaxed", PERSISTENT | BACKUP},
    {"ComfortBrakeAggressive", PERSISTENT | BACKUP},
    {"ComfortBrakeStandard", PERSISTENT | BACKUP},
    {"ComfortBrakeRelaxed", PERSISTENT | BACKUP},
